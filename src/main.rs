...
fn eq_comps(path: &Path, other_path: &Path) {
    ...
    // path.as_os_str() == other_path.as_os_str();
...
fn main() {
    ...
    for i in 0..100 {
        ...
        components_next_back_iter(absolute_long_path_inconsistent_comps.as_ref());
    }
}
